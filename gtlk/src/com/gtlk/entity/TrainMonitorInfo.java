...
public class TrainMonitorInfo{
	...
	public TrainMonitorInfo(String runningTime, String trainName,
			...
			String initiator, String degradationType) {
		super();
