...
public class TestDelayInfo{
	...
	public TestDelayInfo(String route, String detectionTime,
			Double switchSuccessRate, Double switchAveDelay, Double toneDegree,
			Double tAveDelay, Double tInerrantTimeRate, Double linkAveDelayRate) {
		super();
		this.route = route;
