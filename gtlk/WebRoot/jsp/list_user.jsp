...
<body>
<h4 style="background: url(${pageContext.request.contextPath}/styles/images/home.png) no-repeat;"> 当前位置：<a>用户管理</a><span></span></h4>
<h3 style="background: url(${pageContext.request.contextPath}/styles/images/h3-bg.png) repeat-x;">用户</h3>
<div id="main">
	<div id="topCmd" class="command roubd_top">			
		<a class="button" href="javascript:delItems();">批量删除</a>
		<a class="button dialog-link" href="addUserPage.action">添加人员信息</a>			
	<div class="table-container">
    	<s:form id="delForm" action="delUser.action" method="post"
						theme="simple">
				<table border="1" width="100%">
					...
					<tbody>
						<s:iterator value="objs" var="u" status="st">
							<tr style="height: 30px">
								...
								<td style="text-align: center">${u.identity }</td>				
							</tr>
						</s:iterator>
					</tbody>
				</table>
