...
<div id="main">
	<div id="topCmd" class="command roubd_top">
		<a class="button dialog-link" href="addTestDelayInfoPage.action">添加测试集</a>
		<a class="button" href="score.action">批量打分</a>				
	...
	<div class="table-container">
    	<s:form id="delForm" action="delTestDelayInfo" method="post" theme="simple">
				<table border="1" width="100%">
					...
					<tbody>
						<s:iterator value="objs" var="testdi" status="st">
							<tr style="height: 30px">
								<td><input type="checkbox" name="oids" class="select"
											value="${testdi.oid }" />
											</td>
								<td style="text-align: center">${st.count }</td>
								<td style="text-align: center">${testdi.route}</td>
								<td style="text-align: center">${testdi.detectionTime }</td>
								<td style="text-align: center">${testdi.switchSuccessRate}</td>
								<td style="text-align: center">${testdi.switchAveDelay}</td>
								<td style="text-align: center">${testdi.toneDegree}</td>
								<td style="text-align: center">${testdi.tAveDelay}</td>
								<td style="text-align: center">${testdi.tInerrantTimeRate}</td>
								<td style="text-align: center">${testdi.linkAveDelayRate}</td>
								<td style="text-align: center">${testdi.grade}</td>								
								<td style="text-align: center"><a class="dialog-link"
								href="editTestDelayInfoPage.action?oid=${testdi.oid}">修改</a>
									</td>
							</tr>
						</s:iterator>
					</tbody>
