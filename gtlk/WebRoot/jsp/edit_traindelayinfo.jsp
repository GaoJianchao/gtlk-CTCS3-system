...
<div class="table-container special" >
	<s:form width="700px" top='10' action="editTrainDelayInfo.action" theme="simple"
		...
		<div id="topCmd" class="command round_top">
				...
				<tr>
					...
					<td><input type="text"
						name="obj.detectionTime"   style="width: 170px;" onfocus="WdatePicker({dateFmt:'yyyy-MM-dd HH:mm:ss'})" value="${obj.detectionTime}"/></td>
				</tr>
				<tr>
					<td class="label">切换成功率</td>
					<td><input type="text" name="obj.switchSuccessRate" style="width: 170px;"  value="${obj.switchSuccessRate}"/></td>
					<td class="label">切换平均时延</td>
					<td><input type="text" name="obj.switchAveDelay" style="width: 170px;"  value="${obj.switchAveDelay}"/></td>
				</tr>
				<tr>
					<td class="label">话音等级</td>
					<td><input type="text" name="obj.toneDegree" style="width: 170px;"   value="${obj.toneDegree}"/></td>			
					<td class="label">传输时延平均值</td>
					<td><input type="text" name="obj.tAveDelay" style="width: 170px;"  value="${obj.tAveDelay}"/></td>
				</tr>
				<tr>
					<td class="label">传输无差错时间＞7s概率</td>
					<td><input type="text" name="obj.tInerrantTimeRate" style="width: 170px;"   value="${obj.tInerrantTimeRate}"/></td>
					<td class="label">连接建立平均时延概率</td>
					<td><input type="text" name="obj.linkAveDelayRate" style="width: 170px;"  value="${obj.linkAveDelayRate}"/></td>
				</tr>
				<tr>
					<td class="label">评分等级</td>
					<td><input type="text" name="obj.grade" style="width: 170px;"  value="${obj.grade}"/></td>
				</tr>
			</table>
			...
			<p class="buttons">
				...
				<a class="button btn-cancel" href="listTrainDelayInfo.action">取消</a>
			</p>
		</fieldset>
	</s:form>
</div>				