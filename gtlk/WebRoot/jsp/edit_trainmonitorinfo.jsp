...
<div class="table-container special" >
	<s:form width="1000px" top='10' action="editTrainMonitorInfo.action" theme="simple"
		...
		<div id="topCmd" class="command round_top">
				...
				<tr>				
					...
					<td class="label">降级类型</td>
   				    <td><input type="text" name="obj.degradationType" style="width: 170px;" value="${obj.degradationType}"/></td>		
				 </tr>
			</table>
